...
console.log("medium (keepGoin2) output = " + output);
...
let keepGoin3 = myOpt2.match(inside) != null;

let myArr5 = copyObject(data);
if(!keepGoin3){
  myArr5 = myArr5[myOpt];
}
while(keepGoin3){
let myArr4 = myOpt2.match(inside);
//myArr4 = myArr4[0].replace('\/', '')


console.log("myOpt2 = " + myOpt2);
console.log("array4 = " + myArr4);
console.log("array5 = " + myArr5);
console.log("data = " + data);
console.log("a1 = " + data["a1"]);
// console.log("a1 (2) = " + myArr5["a1"]);

myArr5 = myArr5[myArr4[0].replace('\/', '')];
myOpt2 = myOpt2.replace(myArr4[0], '');
console.log("medium (keepGoin3) output = " + output);
keepGoin3 = myOpt2.match(inside) != null;
}
...
async function myArray6Thing(arrayInput){
  ...
  if(arrayInput !== null && !Array.isArray(arrayInput) && typeof arrayInput === 'object'){processedInput = Object.values(arrayInput);}
...
console.log("medium (keepGoin1) output = " + output);
